...
import {
  ...
  CartesianGrid, XAxis, YAxis, Tooltip, Bar, ReferenceLine
} from 'recharts';
import type { ChartData } from '@/modules/solar/types';
// import { MessageSquare, FileCheck, Hammer, Zap } from 'lucide-react'; // Removed unused imports
