        ...
        <Card className="group relative overflow-hidden border-slate-200/60 dark:border-slate-800/60 bg-gradient-to-br from-white via-white to-slate-50/80 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800/80 hover:shadow-lg hover:shadow-purple-500/5 hover:border-purple-200/60 dark:hover:border-purple-500/30 transition-all duration-300">
            ...
            <CardContent className="px-5 pt-5 pb-5">
                <div className="flex items-start justify-between">
                    ...
                    {icon && (
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100/80 dark:from-purple-500/10 dark:to-purple-500/20 flex items-center justify-center text-purple-500 dark:text-purple-400 shrink-0 group-hover:scale-105 transition-transform duration-300">
