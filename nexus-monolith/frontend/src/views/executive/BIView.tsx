    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-4">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Falha ao carregar dados de BI</h3>
    ...
    return (
        <div className="space-y-6">
                ...
                <div>
                    <div className="flex items-center gap-2.5 mb-1">
                        ...
                        <div className="flex items-center gap-1.5 px-2.5 py-1 bg-purple-50 dark:bg-purple-900/30 rounded-full">
                            ...
                            <span className="text-[11px] font-bold text-purple-600 dark:text-purple-400">Analytics</span>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="flex flex-col border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
                    <CardHeader className="border-b border-slate-100 dark:border-slate-800/60 bg-gradient-to-r from-slate-50/80 dark:from-slate-900/80 to-transparent pb-4">
                    ...
                    <CardContent className="p-5 pt-6 flex-1 min-w-0">
                ...
                <Card className="flex flex-col border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
                    ...
                    <CardContent className="p-5 pt-6 flex-1 flex flex-col justify-center min-w-0">
                        <div className="h-[300px] min-h-[300px] w-full flex items-center justify-center min-w-0">
                            {isMounted && (
                                <ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1}>
                                    <PieChart>
                                    <Pie
                ...
                <CardContent className="p-0">
                    <div className="py-16 flex flex-col items-center justify-center text-center space-y-4">
                        <div className="relative">
                            <div className="w-16 h-16 bg-gradient-to-br from-purple-50 to-purple-100/80 dark:from-purple-900/20 dark:to-purple-800/20 rounded-2xl flex items-center justify-center">
                                <Sparkles className="w-7 h-7 text-purple-400" />
                            </div>
                            <div className="absolute -inset-2 bg-purple-200/20 dark:bg-purple-900/20 rounded-3xl blur-xl -z-10 animate-pulse"></div>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Cubo de Dados não conectado</h3>
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-purple-50 dark:bg-purple-900/30 rounded-full mt-2">
                            <Target className="w-3.5 h-3.5 text-purple-500" />
                            <span className="text-[12px] font-semibold text-purple-600 dark:text-purple-400">Evolução do Faturamento por Unidade</span>
                        </div>
                    </div>
                </CardContent>
            </Card>
