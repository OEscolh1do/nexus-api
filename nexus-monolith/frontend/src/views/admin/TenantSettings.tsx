...
export default function TenantSettings() {
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950 p-8 font-sans">
            <div className="max-w-5xl mx-auto space-y-8">
                {/* Header */}
                <div className="flex items-end justify-between">
                    <div>
                        <div className="flex items-center gap-2.5 mb-1">
                            <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Governança Enterprise & API</h1>
                            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-indigo-50 dark:bg-indigo-900/30 rounded-full">
                                ...
                                <span className="text-[11px] font-bold text-indigo-600 dark:text-indigo-400">Admin</span>
                            </div>
                        </div>
                        <p className="text-slate-500 dark:text-slate-400 text-[14px]">Painel de governança corporativa, monetização e políticas de acesso (SSO).</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* SSO Configuration Card */}
                    <Card className="overflow-hidden border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900">
                        ...
                        <div className="p-6">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h2 className="text-[15px] font-bold text-slate-800 dark:text-white">Single Sign-On (SSO)</h2>
                                    <p className="text-[12px] text-slate-400 font-medium">Delegação de Identidade Corporativa</p>
                                </div>
                            </div>

                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-3.5 bg-slate-50/80 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800">
                                    <div>
                                        <p className="text-[13px] font-semibold text-slate-700 dark:text-slate-200">Interceptação de Domínio</p>
                                    ...
                                    <span className={clsx(
                                        ...
                                        tenantMock.ssoEnforced ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 ring-1 ring-emerald-200/80 dark:ring-emerald-800' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400'
                                    )}>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                                        ...
                                        <div className="text-[13px] font-semibold text-slate-800 dark:text-white font-mono">
                                    ...
                                    <div className="p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                                        ...
                                        <div className="text-[13px] font-semibold text-slate-800 dark:text-white flex items-center gap-2">
                                            <Network size={14} className="text-blue-500 dark:text-blue-400" />
                    ...
                    <Card className="overflow-hidden border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900">
                        ...
                        <div className="p-6">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h2 className="text-[15px] font-bold text-slate-800 dark:text-white">API Gateway & Consumo</h2>
                            ...
                            <div className="space-y-5">
                                <div className="flex justify-between items-end">
                                    <div>
                                        ...
                                        <div className="text-[22px] font-black text-slate-800 dark:text-white tracking-tight">
                                            NEXUS <span className="text-emerald-500 dark:text-emerald-400">{tenantMock.apiPlan}</span>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Integrações Ativas</p>
                                        <div className="flex items-center justify-end gap-1.5 text-[13px] font-semibold text-slate-700 dark:text-slate-300">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-[13px]">
                                        <span className="font-semibold text-slate-600 dark:text-slate-300">Consumo de Franquia Mês Atual</span>
                                        <span className="font-bold text-slate-800 dark:text-white">{tenantMock.apiCurrentUsage.toLocaleString()} / {tenantMock.apiMonthlyQuota.toLocaleString()}</span>
                                    </div>
