...
const JWT_SECRET = process.env.JWT_SECRET || "super-secret-default-dev-key"; // Em produção, isso deve falhar se não existir.
...
const IamService = {
  ...
  async getAllUsers() {
    try {
      // console.log("[IamService] Fetching all users...");
