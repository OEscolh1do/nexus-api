...
import { FinanceSlice, createFinanceSlice } from '@/modules/finance/store/financeSlice';
    ...
    persist(
      ...
      }),
      {
        ...
        partialize: (state) => ({
          ...
          // Financeiro (Viabilidade) - NOVO V3.0.0
          financeParams: state.financeParams,
...
export const selectFinanceParams = (state: SolarState) => state.financeParams;
export const selectFinanceResults = (state: SolarState) => state.financeResults;
