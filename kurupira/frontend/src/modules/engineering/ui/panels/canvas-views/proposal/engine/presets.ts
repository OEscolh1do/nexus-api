...
export const PRESET_KPI_BADGE: CanvasPreset = {
  ...
  elements: [
    // Nome do cliente
    { type: 'placeholder', dx: 0, dy: 0, width: 325, height: 20, zIndex: 1, groupId: 'kpi-badge',
    ...
    { type: 'box', dx: 0, dy: 22, width: 22, height: 78, zIndex: 2, groupId: 'kpi-badge',
    ...
    { type: 'text', dx: 0, dy: 22, width: 22, height: 78, zIndex: 3, groupId: 'kpi-badge',
    ...
    { type: 'box', dx: 22, dy: 22, width: 150, height: 78, zIndex: 2, groupId: 'kpi-badge',
    ...
    { type: 'text', dx: 32, dy: 30, width: 130, height: 14, zIndex: 3, groupId: 'kpi-badge',
    ...
    { type: 'placeholder', dx: 32, dy: 48, width: 130, height: 40, zIndex: 3, groupId: 'kpi-badge',
    ...
    { type: 'box', dx: 172, dy: 22, width: 153, height: 78, zIndex: 2, groupId: 'kpi-badge',
      props: { bgColor: '#4CAF50', border: '', borderTop: '', borderRight: '', borderBottom: '', borderLeft: '', borderRadius: 0, opacity: 1, shadow: false } },
    // Label "Geração Mensal"
    { type: 'text', dx: 182, dy: 30, width: 130, height: 14, zIndex: 3, groupId: 'kpi-badge',
    ...
    { type: 'placeholder', dx: 182, dy: 48, width: 130, height: 40, zIndex: 3, groupId: 'kpi-badge',
...
export const PRESET_EQUIPMENT_PANEL: CanvasPreset = {
  ...
  elements: [
    ...
    { type: 'box', dx: 0, dy: 0, width: 343, height: 155, zIndex: 1, groupId: 'equipment-panel',
    ...
    { type: 'box', dx: 0, dy: 0, width: 24, height: 155, zIndex: 2, groupId: 'equipment-panel',
    ...
    { type: 'divider', dx: 24, dy: 80, width: 319, height: 1, zIndex: 3, groupId: 'equipment-panel',
      props: { color: '#E2E8F0', thickness: 1, margin: 0 } },

    // ── Seção Inversores ──
    { type: 'text', dx: 32, dy: 90, width: 150, height: 12, zIndex: 3, groupId: 'equipment-panel',
      props: { content: 'Inversores', fontSize: 8, fontWeight: 900, color: '#94A3B8', textAlign: 'left', fontFamily: 'system', rotation: 0 } },
    { type: 'placeholder', dx: 32, dy: 106, width: 220, height: 16, zIndex: 3, groupId: 'equipment-panel',
      props: { field: 'project.inverterModel', prefix: '', suffix: '', fontSize: 11, fontWeight: 900, color: '#1E293B', textAlign: 'left', italic: false } },
    { type: 'placeholder', dx: 32, dy: 126, width: 220, height: 14, zIndex: 3, groupId: 'equipment-panel',
...
export const PRESET_KPI_CARD: CanvasPreset = {
  ...
  elements: [
    ...
    { type: 'box', dx: 0, dy: 0, width: 170, height: 90, zIndex: 1, groupId: 'kpi-card',
    ...
    // Rótulo
    { type: 'text', dx: 12, dy: 10, width: 146, height: 14, zIndex: 2, groupId: 'kpi-card',
    ...
    { type: 'placeholder', dx: 12, dy: 26, width: 146, height: 38, zIndex: 2, groupId: 'kpi-card',
      props: { field: 'project.power', prefix: '', suffix: '', fontSize: 28, fontWeight: 900, color: '#4CAF50', textAlign: 'left', italic: false } },
    // Unidade/legenda
    { type: 'text', dx: 12, dy: 68, width: 146, height: 14, zIndex: 2, groupId: 'kpi-card',
...
export const PRESET_GUARANTEE_BULLET: CanvasPreset = {
  ...
  elements: [
    // Fundo do ícone
    { type: 'box', dx: 0, dy: 4, width: 28, height: 28, zIndex: 1, groupId: 'guarantee-bullet',
      props: { bgColor: '#f0fdf4', border: '', borderTop: '', borderRight: '', borderBottom: '', borderLeft: '', borderRadius: 6, opacity: 1, shadow: false } },
    // Ícone
    { type: 'icon', dx: 4, dy: 8, width: 20, height: 20, zIndex: 2, groupId: 'guarantee-bullet',
      props: { name: 'Shield', size: 14, color: '#16a34a', bgColor: '', bgRadius: 0 } },
    // Título
    { type: 'text', dx: 36, dy: 4, width: 264, height: 16, zIndex: 2, groupId: 'guarantee-bullet',
      props: { content: 'Título da Garantia', fontSize: 10, fontWeight: 800, color: '#1E293B', textAlign: 'left', fontFamily: 'system', rotation: 0 } },
    // Descrição
    { type: 'text', dx: 36, dy: 22, width: 264, height: 18, zIndex: 2, groupId: 'guarantee-bullet',
