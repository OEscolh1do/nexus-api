...
export const DEFAULT_ELEMENT_PROPS: Record<CanvasElementType, Record<string, unknown>> = {
  ...
  'chart-generation':{ showLegend: true, title: 'Geração Mensal Estimada' },
  'chart-financial': { showLegend: true, title: 'Projeção Financeira' },
  ...
  'placeholder':            { field: 'client.name', prefix: '', suffix: '', fontSize: 14, fontWeight: 400, color: '#1a1a1a', textAlign: 'left', italic: false, letterSpacing: '', textTransform: 'none', lineHeight: '' },
  ...
  // Primitivos
  'box':                    { bgColor: '#e2e8f0', gradient: '', border: '', borderTop: '', borderRight: '', borderBottom: '', borderLeft: '', borderRadius: '0', overflow: 'visible', opacity: 1, shadow: false },
