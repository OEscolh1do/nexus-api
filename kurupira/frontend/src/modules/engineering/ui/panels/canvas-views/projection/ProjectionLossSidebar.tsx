...
export const ProjectionLossSidebar: React.FC = () => {
  ...
  return (
    <div className={cn(
      "w-72 h-full flex flex-col bg-slate-950/80 backdrop-blur-xl border-l border-amber-900/20",
      "animate-in slide-in-from-right duration-300 ease-out z-20"
    )}>
      
      {/* ── Header ─────────────────────────────────────────────────────────── */}
      <div className="flex items-center justify-between px-4 py-4 border-b border-white/[0.05] bg-amber-500/5">
        ...
        <button 
          ...
          className="p-1.5 hover:bg-white/10 text-slate-500 hover:text-white transition-colors"
        >
          <X size={14} />
        </button>
      </div>
            ...
            <div key={cfg.key} className="space-y-2 group/row">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="opacity-0 group-hover/row:opacity-100 transition-opacity cursor-help" title={cfg.description}>
      ...
      {/* ── Footer ─────────────────────────────────────────────────────────── */}
      <div className="p-4 bg-black/40 border-t border-white/[0.05] space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-[8px] font-black text-slate-500 uppercase">PR Final Estimado</span>
          ...
          <button
            onClick={resetLosses}
            className="flex items-center gap-1.5 px-3 py-1.5 border border-slate-800 text-[9px] font-black uppercase tracking-wider
