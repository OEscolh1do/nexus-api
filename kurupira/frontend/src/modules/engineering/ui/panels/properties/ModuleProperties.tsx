      ...
      <div className="px-3 space-y-5 pb-6">
        <section>
          ...
          <div className="mt-2 space-y-0.5">
            <PropRow label="Fabricante" value={module.manufacturer} mono={false} />
            <PropRow label="Modelo" value={module.model} mono={false} />
            <PropRow label="Potência" value={`${module.power}W`} accent />
            <PropRow label="Tipo" value={module.type || '—'} mono={false} />
        ...
        <section>
          ...
          <div className="mt-2 space-y-0.5">
            {placedInstance ? (
              <PropRow label="Status Físico" value="Mapeado" accent mono={false} />
            ) : (
              <PropRowEditable
                label="Quantidade"
            ...
            <PropRow label="Orientação" value={engineering?.orientation || '—'} mono={false} />
          </div>
        </section>
