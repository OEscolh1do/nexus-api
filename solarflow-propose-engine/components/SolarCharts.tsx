...
import { MessageSquare, FileCheck, Hammer, Zap } from 'lucide-react';
...
const ReferenceLine = ({ y, stroke, strokeDasharray }: any) => (
    <line x1="0" y1={y} x2="100%" y2={y} stroke={stroke} strokeDasharray={strokeDasharray} />
);
