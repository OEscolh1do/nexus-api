...
<system_role>
  ...
  Stack: {{CONSULTE_STACK_CONFIG.md OU ESPECIFIQUE: Frontend, Backend, Database}}.
  Princípios: Clean Code, SOLID, Segurança por Design.
</system_role>
